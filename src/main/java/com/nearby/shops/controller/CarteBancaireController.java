...
public class CarteBancaireController {
    ...
    @GetMapping("/{id}")
    public Optional<CarteBancaire> GetByID(@PathVariable Integer id) {return this.carteBancaireService.FindByID(id);}
    ...
    @PutMapping("/{id}")
    CarteBancaire Update(@RequestBody CarteBancaire nouvelleCarteBancaire, @PathVariable Integer id) {
